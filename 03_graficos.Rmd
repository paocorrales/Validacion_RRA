...
gf <- estadisticos[, hora.ini := hour(fecha.ini)] %>% 
  ...
  .[hora.ini == 12 & var.type %in% c("T2m", "u10m", "v10m")] %>% 
...
ggsave("fig/param_completo.pdf", width = 20, height = 15, units = "cm")
